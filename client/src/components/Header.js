                ...
                <li className="nav-item dropup">
                  ...
                  <li className="nav-item" >
                        ...
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <Avatar src={auth.user.avatar} size="medium-avatar" theme={theme} />
                        </span>
    
                        <div className="dropdown-menu" style={{position:"absolute",transform:"translate(20%,60%)"}} aria-labelledby="navbarDropdown">
